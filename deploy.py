...
def plot_boxes(results, frame,classes):
    ...
    for i in range(n):
        ...
        if row[4] >= 0.55: ### threshold value for detection. We are discarding everything below this value
            ...
            cv2.rectangle(frame, (x1, y1-25), (x2, y1), (0, 255,0), -1) ## for text label background
            cv2.putText(frame, f"{plate_num}", (x1, y1), cv2.FONT_HERSHEY_SIMPLEX, 1,(255,255,255), 3)
...
def process(img_path = None, vid_path = None, vid_out = None):
...
# main(vid_path="C:/Users/16dib/Desktop/numberplaterecognition-main/test_images/test_vid_1.mp4",vid_out="vid_4.mp4") ### for custom video

# main(vid_path=0,vid_out="webcam_result.mp4") #### for webcam
# main(img_path="C:/Users/16dib/Desktop/numberplaterecognition-main/test_images/Cars118.jpg") 
...
# cap = cv2.VideoCapture(r'C:\Users\16dib\Desktop\numberplaterecognition-main\test_images\vid.mp4')
